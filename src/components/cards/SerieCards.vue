                  ...
                  <div v-for="serie in listSeries" :key="serie"
                   ...
                   <div class="relative">
                     ...
                     <div class="absolute top-0 w-full h-full flex justify-center items-center cursor-pointer">
                       <p class="text-white font-bold text-center text-base moserrat-bold">{{serie.name}}</p>
                     </div>
                    </div>
                  </div>
                  </div>
                  ...
                  <div v-for="serie in listSeries" :key="serie"
                   ...
                   <div @click="onSelectSerie(serie)">
                     ...
                     <div class="absolute top-0 w-full h-full flex justify-center items-center">
                       <p class="text-white text-center font-bold text-base">{{serie.name}}</p>
                     </div>
                   </div>
                  </div>
              </div>
  ...
  <div v-else>
    <div class="w-full relative mb-2 "
      ...
      <div class="relative">
         ...
         <div class="absolute top-0 w-full h-full flex justify-center items-center">
           <p class="text-white font-bold text-center text-base moserrat-bold">{{serieSelected.name}}</p>
         </div>
